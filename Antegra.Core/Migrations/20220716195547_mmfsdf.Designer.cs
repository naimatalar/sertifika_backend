...
namespace Labote.Core.Migrations
{
    ...
    [Migration("20220716195547_mmfsdf")]
    partial class mmfsdf
    {
            ...
            modelBuilder.Entity("Labote.Core.Entities.Cargo", b =>
                {
                    ...
                    b.HasIndex("CargoDriverUserId")
                        .IsUnique()
                        .HasFilter("[CargoDriverUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("Labote.Core.Entities.Cargo", b =>
                {
                    b.HasOne("Labote.Core.Entities.CargoDriverUser", "CargoDriverUser")
                        .WithOne("Cargo")
                        .HasForeignKey("Labote.Core.Entities.Cargo", "CargoDriverUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Labote.Core.Entities.CargoSenderUser", "CargoSenderUser")
                        .WithOne("Cargo")
                        .HasForeignKey("Labote.Core.Entities.Cargo", "CargoSenderUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
